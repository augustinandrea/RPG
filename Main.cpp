...
void characterInitialization()
{
	characters[0] = Archer("Virion", "Archer", false, 19, 19, 60, 70, 40, 5, 15, 0);
        ...
        characters[6] = Cleric("Lissa", "Cleric", false, 18, 18, 100, 70, 0, 0, 0, 10);
        characters[7] = Cleric("Brady", "Cleric", false, 18, 18, 100, 70, 0, 0, 0, 10);
        ...
        characters[12] = Knight("Kellam", "Knight", false, 25, 25, 15, 65, 45, 9, 20, 0);
        characters[13] = Knight("Kjelle", "Knight", false, 21, 21, 60, 90, 70, 7, 15, 0);
        characters[14] = Lord("Chrom", "Lord", false, 21, 21, 90, 60, 70, 7, 12, 0);
        characters[15] = Lord("Lucina", "Lord", false, 21, 21, 90, 63, 70, 5, 17, 0);
        characters[16] = Mage("Ricken", "Mage", false, 20, 20, 70, 50, 65, 8, 18, 0);
        characters[17] = Mage("Miriel", "Mage", false,21, 21, 75, 60, 50, 6, 12, 0);
        characters[18] = Mercenary("Gregor", "Mercenary", false, 30, 30, 65, 50, 12, 20, 0);
        characters[19] = Mercenary("Severa", "Mercenary", false, 12, 12, 95, 35, 10, 18, 0);
        characters[20] = Myrmidon("Lon'qu", "Myrmidon", false, 20, 20, 65, 75, 55, 6, 13,0);
        characters[21] = Myrmidon("Owain", "Myrmidon", false, 15, 15, 95, 35, 50, 8, 17, 0);
        ...
        characters[24] = Tactician("Robin", "Tactician", false, 19, 19, 95, 50, 55, 9, 18, 0);
        characters[25] = Tactician("Morgan", "Tactician", false, 19, 19, 95, 50, 55, 9, 18, 0);
        characters[26] = Thief("Gaius", "Thief", false, 22, 22, 70, 70, 40, 7, 13, 0);
        characters[27] = Thief("Anna", "Thief", false, 22, 22, 70, 70, 40, 7, 13, 0);
        characters[28] = Troubadour("Maribelle", "Troubadour", false, 18, 18, 100, 70, 0, 0, 0, 10);
        characters[29] = Troubadour("Libra", "Troubadour", false, 18, 18, 100, 70, 0, 0, 0, 15);
        characters[30] = WyvernRider("Cherche", "Wyvern Rider", false, 25, 25, 55, 50, 50, 14, 23, 0);
        characters[31] = WyvernRider("Gerome", "Wyvern Rider", false, 22, 22, 64, 55, 40, 10, 19, 0);
}
