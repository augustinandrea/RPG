...
void characterInitialization()
{
	characters[0] = Archer("Virion", "Archer", false, 19, 19, 60, 70, 40, 5, 15, 0);
        ...
        characters[6] = Cleric("Lissa", "Cleric", false, 18, 18, 70, 100, 0, 0, 0, 10);
        characters[7] = Cleric("Brady", "Cleric", false, 18, 18, 70, 100, 0, 0, 0, 10);
        ...
        characters[29] = Troubadour("Libra", "Troubadour", false, 18, 18, 70, 100, 0, 0, 0, 15);
